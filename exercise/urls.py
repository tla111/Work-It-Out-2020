...
from tracker.views import dashboard_view, add_workout_view, workout_detail_view, new_workout_view, in_progress_workout_view, done_workout_view, invalid_workout_view
